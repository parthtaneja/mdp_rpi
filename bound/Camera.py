...
for c in cnts:
    ...
    print ("Found {} contours".format(len(approx)))
    if len(approx) >= 7:
        screenCnt = approx
        break
...
if minIndex == 0:
    ...
    x, y, w, h = cv2.boundingRect(screenCnt)
    cv2.rectangle(image, (x, y), (x+w, y+h), (0, 255, 0), 1)
    cv2.putText(image, "RIGHT", (x, y-10), cv2.FONT_HERSHEY_DUPLEX,
    ...
    x, y, w, h = cv2.boundingRect(screenCnt)
    cv2.rectangle(image, (x, y), (x+w, y+h), (0, 255, 0), 1)
    cv2.putText(image, "LEFT", (x, y-10), cv2.FONT_HERSHEY_DUPLEX,
                1, (255, 255, 255), 2, cv2.LINE_AA)
    ...
    x, y, w, h = cv2.boundingRect(screenCnt)
    cv2.rectangle(image, (x, y), (x+w, y+h), (0, 255, 0), 1)
    cv2.putText(image, "UP", (x, y-10), cv2.FONT_HERSHEY_DUPLEX,
                1, (255, 255, 255), 2, cv2.LINE_AA)
    cv2.imshow("UP", image)
    cv2.waitKey(0)
else:
    ...
    x, y, w, h = cv2.boundingRect(screenCnt)
    cv2.rectangle(image, (x, y), (x+w, y+h), (0, 255, 0), 1)
    cv2.putText(image, "DOWN", (x, y-10), cv2.FONT_HERSHEY_DUPLEX,
                1, (255, 255, 255), 2, cv2.LINE_AA)
